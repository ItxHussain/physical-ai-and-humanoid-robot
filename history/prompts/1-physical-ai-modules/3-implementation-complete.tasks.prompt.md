...
labels: [implementation,physical-ai,book]
links:
  spec: null
  ticket: null
  adr: null
...
tests:
  ...
  - word count verification (5010+ words)
...
6. **Quality Assurance**:
   - Word count: 5,010+ words (within 5,000-7,000 requirement)
...
- Graders run and results (PASS/FAIL): All success criteria met
